...
__all__ = ['resnet20_1w1a','resnet20_1w32a']
...
class BasicBlock_1w32a(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = BinarizeConv2d_32a(in_planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = BinarizeConv2d_32a(planes, planes, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
...
class ResNet_32a(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet_32a, self).__init__()
        self.in_planes = 16
...
def resnet20_1w32a(num_classes=10):
    return ResNet_32a(BasicBlock_1w32a, [3, 3, 3],num_classes=num_classes)
