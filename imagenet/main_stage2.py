...
def main():
    ...
    if not args.resume and args.load_ckpt_stage1 is not None:
        checkpoint_file = args.load_ckpt_stage1
        print(f"===> Loading best checkpoint from stage 1: {checkpoint_file}")
